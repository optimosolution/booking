...
class ServiceCategoryController extends Controller {
    ...
    public function actionView($id) {
        $this->page_title = 'Service Category Details';
    ...
    public function actionCreate() {
        $this->page_title = 'New Service Category';
    ...
    public function actionNew() {
        ...
        if (isset($_POST['ServiceCategory'])) {
            ...
            $model->company = Yii::app()->user->company;
            if ($model->save()) {
                Yii::app()->user->setFlash('success', "Service Category has been created successfully.");
                ?>
                <script>
                    window.parent.$.fancybox.close();
                    //parent.location.reload(true);
                    window.parent.update_category();
                </script>
                <?php
    ...
    public function actionUpdate($id) {
        $this->page_title = 'Edit Service Category';
        $model = $this->loadModel($id);
    ...
    public function actionAdmin() {
        $this->page_title = 'Service Categories';
