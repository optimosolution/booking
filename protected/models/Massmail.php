...
class Massmail extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('user_group, user_status, created_by, modified_by, customer_id', 'numerical', 'integerOnly' => true),
            array('subject', 'length', 'max' => 250),
            array('modified_on, send_on, created_by', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, user_group, user_status, subject, message_body, created_by, created_on, modified_by, modified_on, customer_id, send_on', 'safe', 'on' => 'search'),
        );
    }
