...
class CustomerHistory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('appointment_id, shop_id, customer_id, appoint_date, service_id', 'required'),
			array('appointment_id, shop_id, customer_id, service_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, appointment_id, shop_id, customer_id, appoint_date, service_id', 'safe', 'on'=>'search'),
		);
	}
