...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'servic_id'); ?>
		<?php echo $form->textField($model,'servic_id'); ?>
		<?php echo $form->error($model,'servic_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'time_required'); ?>
		<?php echo $form->textField($model,'time_required',array('size'=>50,'maxlength'=>50)); ?>
