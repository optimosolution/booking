...
<div class="appointmentsNote" style="padding:20px; margin:20px 0;">
    ...
    <?php } ?>
        ...
        <div class="col-sm-6" style="padding-top:30px; padding-left:10px;">
            ...
            <p><strong>IP Address:</strong> <?php echo $valuesY['ip']; ?></p>
            ...
            <?php } ?>
             <?php echo CHtml::link('Delete','#', array('submit'=>array('appointmentNote/delete','id'=>$valuesY['id'],'v'=>$model->id),'confirm'=>'Are you sure?','class' => 'btn btn-warning btn-mini')); 
             ?>
