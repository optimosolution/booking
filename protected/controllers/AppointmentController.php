...
public function actionCost_range()
	{
		unset(Yii::app()->request->cookies['cost_range_from']);  // first unset cookie for dates
		unset(Yii::app()->request->cookies['cost_range_to']);
		...
		$model->unsetAttributes();  // clear any default values
		  ...
		  if(!empty($_POST))
		  {
		    Yii::app()->request->cookies['cost_range_from'] = new CHttpCookie('cost_range_from', $_POST['cost_range_from']);  // define cookie for cost_range_from
		    Yii::app()->request->cookies['cost_range_to'] = new CHttpCookie('cost_range_to', $_POST['cost_range_to']);
		    $model->cost_range_from = $_POST['cost_range_from'];
		    $model->cost_range_to = $_POST['cost_range_to'];
			}
